...
class AddLeaveout extends StatefulWidget {
  const AddLeaveout({Key? key}) : super(key: key);

  @override
  State<AddLeaveout> createState() => _AddLeaveoutState();
}

class _AddLeaveoutState extends State<AddLeaveout> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: standardAppBar(context,
          "${AppLocalizations.of(context)!.translate("add_leaveout")!}"),
